...
const components: Component[] = [
  {
    id: 'button',
    name: 'Button',
    description: 'クリック可能なボタンコンポーネント。様々なサイズとスタイルをサポート。',
    category: 'form',
  ...
  },
  {
    id: 'input',
    name: 'Input',
    description: 'テキスト入力フィールド。バリデーションとエラーハンドリングをサポート。',
    category: 'form',
  ...
  },
  {
    id: 'tabs',
    name: 'Tabs',
    description: 'タブナビゲーション。キーボード操作とアクセシビリティをサポート。',
    category: 'navigation',
    icon: <Layers className="w-6 h-6" />,
    status: 'stable',
  },
  {
    id: 'select',
    name: 'Select',
    description: 'ドロップダウン選択コンポーネント。検索とフィルタリング機能付き。',
    category: 'form',
    icon: <Box className="w-6 h-6" />,
    status: 'beta',
  },
  ...
  },
  {
    id: 'menu',
    name: 'Menu',
    description: 'ドロップダウンメニュー。サブメニューとキーボード操作をサポート。',
    category: 'navigation',
    icon: <Layers className="w-6 h-6" />,
    status: 'stable',
  },
              ...
              >
                <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 hover:border-cyan-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10 h-full flex flex-col">
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span
                      className={`px-2 py-1 rounded text-xs font-semibold border ${statusColors[component.status]}`}
                    >
